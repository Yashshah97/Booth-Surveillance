                  ...
                  <div class="row">
					...
					<div class="row">
                                       <div class="col-md-6">
                                             ...
                                             <f:input path="loginVO.username"  placeholder="EmailAddress" class="form-control" required="required"/>
						...
						<div class="row">
                                       <div class="col-md-6">
                                             ...
                                             <f:input path="loginVO.password" type="password"  placeholder="Password" class="form-control" required="required"/>
					...
					<div class="row">
						...
						<div class="row">
                                       <div class="col-md-6">
                                             ...
                                             <f:input path="mobileNumber"  placeholder="MobileNumber" class="form-control" required="required"/>
