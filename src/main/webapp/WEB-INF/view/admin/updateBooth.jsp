                                    ...
                                    <f:form  action="updateBooth" modelAttribute="BoothVO" method="post">
                                       ...
                                       <div class="col-md-6">
                                             <div class="form-group">
                                              <f:input type="text" placeholder="Booth No" class="form-control" path="boothNo" required="required" />
										...
										<div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                   <f:input type="text" placeholder="Required Person" class="form-control" path="requiredPerson" required="required" />
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                             <f:textarea placeholder="Address"  path = "boothAddress" class="form-control" required="required" ></f:textarea>
                                              <f:hidden path="boothId"></f:hidden>  
                                             </div>
                                          </div>
