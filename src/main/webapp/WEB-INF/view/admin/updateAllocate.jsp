               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                       ...
                       Boothno: <f:select path="BoothVO.boothId" class="form-control">
                                              <f:options items="${boothList}" itemLabel="boothNo" itemValue="boothId"/>
                                             </f:select>
                        </div>
                     
                        <div class="form-group">
                        Officername:<f:select path="StaffVO.staffId" class="form-control">
                                              <f:options items="${staffList}" itemLabel="firstName" itemValue="staffId"/>
                                             </f:select>
                        </div>
                                       
                            <div class="form-group">
                            <f:input path="startingDate" type="date" placeholder="Starting date" class="form-control"/>
                        
                        </div>
                        
                        
                        <div class="form-group">
                        <f:input path="endingDate" type="date" placeholder="ending date" class="form-control"/>
                        <f:hidden path="allocateId"></f:hidden>
                        </div>
                        <div class="row">
                                          <div class="col-md-12">
                                             <div class="form-group">
